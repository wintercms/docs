...
![image](https://github.com/wintercms/docs/blob/master/images/list-scoreboard.png?raw=true) {.img-responsive .frame}
...
![image](https://github.com/wintercms/docs/blob/master/images/name-title-indicators.png?raw=true) {.img-responsive .frame}
...
![image](https://github.com/wintercms/docs/blob/master/images/traffic-sources.png?raw=true) {.img-responsive .frame}
...
![image](https://github.com/wintercms/docs/blob/master/images/bar-chart.png?raw=true) {.img-responsive .frame}

...
>**Note:** For a list of all events available in Winter CMS itself, see the [events documentation](https://wintercms.com/docs/events/event/translator.beforeResolve).
